...
import { errorRequestHandler } from "~/src/middlewares/errorRequestHandler";
...
initialize({
  ...
  operations: {
    ...
    putCallManagement: [presenters.callManagementUpdate.show],
    ...
    getReceptionSearch: [presenters.receptionsSearch.show],
    getItemCerrito: [],
    getLensReplacement: [],
  },
});
