...
import { PrescriptionsPresenter } from "~/src/presenters/prescriptions/PrescriptionsPresenter";
...
container
  .bind<IPrescriptionsPresenter>(PresenterTypes.IPrescriptionsPresenter)
  .to(PrescriptionsPresenter);
container
